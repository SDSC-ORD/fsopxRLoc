...
get_fso_px_download_url <- function(px_id) {
  ...
  if (!is_px_cube_url) {
    stop("This id does not belong to a px cube file, check https://www.bfs.admin.ch/bfs/en/home/services/recherche/stat-tab-online-data-search.html for valid px cube ids.")
  }
  return(download_url)
}
